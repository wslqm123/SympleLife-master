...
import com.github.symplelife.fragment.listFragment.VideoListFragment;
import com.github.symplelife.tools.UiUtils;


public class VideoFragment extends BaseFragment implements MenuItem.OnMenuItemClickListener{
	...
	protected View initView(){
		...
		tab_names = UiUtils.getStringArray(R.array.video_tab);
...
//				creatFragment.show();//当页面切换的时候重新请求服务器修改状态
	...
	private class MainAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			return VideoListFragment.newInstance(tab_names[position], position);
		}
