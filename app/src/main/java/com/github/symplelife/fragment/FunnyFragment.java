...
import com.github.symplelife.fragment.listFragment.FunnyListFragment;
import com.github.symplelife.fragment.listFragment.JokesListFragment;
import com.github.symplelife.tools.UiUtils;


public class FunnyFragment extends BaseFragment implements MenuItem.OnMenuItemClickListener{
	...
	protected View initView(){
		...
		tab_names = UiUtils.getStringArray(R.array.funny_tab);
...
//				creatFragment.show();//当页面切换的时候重新请求服务器修改状态
	...
	private class MainAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int position) {
			if (position == 4){
				return FunnyListFragment.newInstance(tab_names[position], position);
			}
			return JokesListFragment.newInstance(tab_names[position], position);
		}
