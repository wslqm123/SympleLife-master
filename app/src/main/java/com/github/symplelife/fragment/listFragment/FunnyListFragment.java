...
import com.github.symplelife.adapter.EssenceAdapter;
 ...
 */
public class FunnyListFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private List<FunnyEntry.Essence> funnyList =new ArrayList<FunnyEntry.Essence>();
    ...
    public static FunnyListFragment newInstance(String keyWord,int position)
    {
        FunnyListFragment f = new FunnyListFragment();
...
//        init();
        adapter = new EssenceAdapter(getActivity(),keyWord, funnyList);
...
//    public abstract void loadData(String what);
    ...
    public void loadData(final int type){
        ...
        String url = ApiConstants.ESSENCE_LIST + max_behot_time;
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                funnyEntry = GsonUtils.jsonToBean(result, FunnyEntry.class);

                if (funnyEntry.has_more.equals("false")){
                ...
                max_behot_time = funnyEntry.next.max_behot_time;
                funnyList.addAll(funnyEntry.data);
